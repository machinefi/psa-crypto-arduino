...
/* See iotex_config.h for definition */
	 ...
	 *          is safe.
	 */
	static inline void psa_set_key_enrollment_algorithm(psa_key_attributes_t* attributes,
	 ...
	 */
	psa_status_t iotex_psa_inject_entropy(const uint8_t* seed, size_t seed_size);
...
#define PSA_DSA_KEY_DOMAIN_PARAMETERS_SIZE(key_bits)                                               \
	 ...
	 */
	static inline psa_ecc_family_t iotex_ecc_group_to_psa(iotex_ecp_group_id grpid, size_t* bits)
	{
		switch(grpid)
		{
	 ...
	 *                      correct for \p curve.
	 */
	iotex_ecp_group_id iotex_ecc_group_of_psa(psa_ecc_family_t curve, size_t bits,
											  int bits_is_sloppy);
#endif /* IOTEX_ECP_C */
...
#define IOTEX_PSA_KEY_ID_BUILTIN_MAX ((psa_key_id_t)0x7fffefff)
	 ...
	 */
	psa_status_t iotex_psa_platform_get_builtin_key(psa_key_id_t key_id,
...
#define PSA_PAKE_OPERATION_INIT                                                                    \
	...
	static inline void psa_pake_cs_set_algorithm(psa_pake_cipher_suite_t* cipher_suite,
												 psa_algorithm_t algorithm)
	{
	...
	static inline void psa_pake_cs_set_primitive(psa_pake_cipher_suite_t* cipher_suite,
												 psa_pake_primitive_t primitive)
	{
	...
	static inline psa_pake_family_t
