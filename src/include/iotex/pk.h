...
#if defined(IOTEX_ECDSA_C) && IOTEX_ECDSA_MAX_LEN > IOTEX_PK_SIGNATURE_MAX_SIZE
...
typedef void iotex_pk_restart_ctx;
	...
	typedef int (*iotex_pk_rsa_alt_sign_func)(void* ctx,
											  ...
											  void* p_rng, iotex_md_type_t md_alg,
	 ...
	 */
	int iotex_pk_verify(iotex_pk_context* ctx, iotex_md_type_t md_alg, const unsigned char* hash,
	 ...
	 */
	int iotex_pk_verify_restartable(iotex_pk_context* ctx, iotex_md_type_t md_alg,
	 ...
	 */
	int iotex_pk_verify_ext(iotex_pk_type_t type, const void* options, iotex_pk_context* ctx,
							iotex_md_type_t md_alg, const unsigned char* hash, size_t hash_len,
							const unsigned char* sig, size_t sig_len);
	 ...
	 */
	int iotex_pk_sign(iotex_pk_context* ctx, iotex_md_type_t md_alg, const unsigned char* hash,
	 ...
	 *
	 */
	int iotex_pk_sign_ext(iotex_pk_type_t pk_type, iotex_pk_context* ctx, iotex_md_type_t md_alg,
	 ...
	 *                  operations was reached: see \c iotex_ecp_set_max_ops().
	 */
	int iotex_pk_sign_restartable(iotex_pk_context* ctx, iotex_md_type_t md_alg,
								  const unsigned char* hash, size_t hash_len, unsigned char* sig,
								  size_t sig_size, size_t* sig_len,
								  int (*f_rng)(void*, unsigned char*, size_t), void* p_rng,
								  iotex_pk_restart_ctx* rs_ctx);
	 ...
	 * \return          0 on success, or a specific error code.
	 */
	int iotex_pk_decrypt(iotex_pk_context* ctx, const unsigned char* input, size_t ilen,
	 ...
	 * \return          0 on success, or a specific error code.
	 */
	int iotex_pk_encrypt(iotex_pk_context* ctx, const unsigned char* input, size_t ilen,
						 unsigned char* output, size_t* olen, size_t osize,
						 int (*f_rng)(void*, unsigned char*, size_t), void* p_rng);
	 ...
	 */
	int iotex_pk_check_pair(const iotex_pk_context* pub, const iotex_pk_context* prv,
							int (*f_rng)(void*, unsigned char*, size_t), void* p_rng);
	 ...
	 */
	int iotex_pk_parse_key(iotex_pk_context* ctx, const unsigned char* key, size_t keylen,
	 ...
	 * \return          0 if successful, or a specific PK or PEM error code
	 */
	int iotex_pk_parse_public_key(iotex_pk_context* ctx, const unsigned char* key, size_t keylen);
	 ...
	 * \return          0 if successful, or a specific PK or PEM error code
	 */
	int iotex_pk_parse_keyfile(iotex_pk_context* ctx, const char* path, const char* password,
							   int (*f_rng)(void*, unsigned char*, size_t), void* p_rng);
	 ...
	 */
	int iotex_pk_parse_subpubkey(unsigned char** p, const unsigned char* end, iotex_pk_context* pk);
#endif /* IOTEX_PK_PARSE_C */
	 ...
	 */
	int iotex_pk_write_pubkey(unsigned char** p, unsigned char* start, const iotex_pk_context* key);
#endif /* IOTEX_PK_WRITE_C */
 ...
 */
	 ...
	 */
	int iotex_pk_wrap_as_opaque(iotex_pk_context* pk, iotex_svc_key_id_t* key, psa_algorithm_t alg,
