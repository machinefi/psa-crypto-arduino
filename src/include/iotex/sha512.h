...
extern "C"
{
	 ...
	 */
	void iotex_sha512_clone(iotex_sha512_context* dst, const iotex_sha512_context* src);
	 ...
	 * \return         A negative error code on failure.
	 */
	int iotex_sha512_update(iotex_sha512_context* ctx, const unsigned char* input, size_t ilen);
	 ...
	 * \return         A negative error code on failure.
	 */
	int iotex_sha512_finish(iotex_sha512_context* ctx, unsigned char* output);
	 ...
	 * \return         A negative error code on failure.
	 */
	int iotex_internal_sha512_process(iotex_sha512_context* ctx, const unsigned char data[128]);
	 ...
	 * \return         A negative error code on failure.
	 */
	int iotex_sha512(const unsigned char* input, size_t ilen, unsigned char* output, int is384);
